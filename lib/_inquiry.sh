...
get_link_git() {
  ...
  print_banner
  printf "${WHITE} 💻 Insira o link do GitHub da versão do CheSuite que deseja instalar:${GRAY_LIGHT}"
  printf "\n\n"
  read -p "> " link_git
}
...
inquiry_options() {
  ...
  print_banner
  printf "${WHITE} 💻 Bem vindo(a) ao Gerenciador CheSuite!, Selecione abaixo a proxima ação!${GRAY_LIGHT}"
  printf "\n\n"
